...
class TiingoNewsDataAlgorithm(QCAlgorithm):
    ...
    def Initialize(self) -> None:
        ...
        csv = self.Download("https://www.dropbox.com/scl/fi/p2r6cvq67j43ivh8ik95s/news_score_apple_2022.csv?rlkey=gn8g34iebfdisb5jd4dsyu13x&dl=0")

        self.score_df = pd.read_csv(StringIO(csv), index_col=0)
    ...
    def OnData(self, slice: Slice) -> None:
        if slice.ContainsKey(self.tiingo_symbol):
            ...
            if score == 1 and self.target_holdings < 1:
